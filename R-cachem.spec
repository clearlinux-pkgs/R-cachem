...
Source0  : https://cran.r-project.org/src/contrib/cachem_1.1.0.tar.gz
...
%setup -q -n cachem
pushd ..
cp -a cachem buildavx2
popd
pushd ..
cp -a cachem buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715877410
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/cachem/libs/cachem.so
/V4/usr/lib64/R/library/cachem/libs/cachem.so
